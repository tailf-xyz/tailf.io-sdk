...
function open(options = {}) {
  let { rows, columns, meta, id, host = 'https://tailf.io', keep_open } = options;
  ...
  if (id) {
    ...
    Object.assign(opts, {
      ...
      , body    :  JSON.stringify({ rows, columns, meta, keep_open })
    });
  }
...
function end(id, options = {}) {
  let { id, host = 'https://tailf.io', keep_open } = options;
